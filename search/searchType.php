                    ...
                    <div class="card my-1 shadow-sm">
                        ...
                        <div class="row "> 
                                <div class="col-1 ">
                                    ...
                                    <img src="<?php echo $web.$target['username']?>/pic/<?php echo $target['profile_dir'] ?>-profile.jpg" alt="" class="ratio-1x1 rounded-circle p-1 float-start " width="60px" height="60px">
                                    </a>
                                </div>
                                <div class="col ps-0 ">
                                    <div class="row ">
